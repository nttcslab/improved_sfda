...
def _rgb_to_hsv(img: torch.Tensor) -> torch.Tensor:
    return kornia.color.rgb_to_hsv(img)
...
def shear_x(img: torch.Tensor,
    ...
    return kornia.geometry.transform.shear(img, mag)
...
def translate_x(img: torch.Tensor,
    ...
    return kornia.geometry.transform.translate(img, mag)
...
def rotate(img: torch.Tensor,
           mag: torch.Tensor) -> torch.Tensor:
    return kornia.geometry.transform.rotate(img, mag)
